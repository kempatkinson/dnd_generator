...
export default class Tutorial extends Component {
    ...
    updatePublished(status) {
        var data = {
            ...
            xp: this.state.currentTutorial.xp,
            dexterity: this.state.currentTutorial.dexterity,
            armor_class: this.state.currentTutorial.xp,
        ...
        return ( <
            div > {
                currentTutorial ? ( <
                    ...
                    div className = "form-group" >
                    <
                    label htmlFor = "xp" > Description < /label> <
                    input type = "text"
                    className = "form-control"
                    id = "xp"
                    value = { currentTutorial.xp }
